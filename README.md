...
1. **中華民國國旗**（青天白日滿地紅）——依據[**中華民國內政部**](https://www.moi.gov.tw/cp.aspx?n=10621)頒布之國旗畫法繪製。
2. **鐵血十八星旗**——辛亥革命武昌起義旗幟，依據[**武昌首義同志會**](https://www.19111010.com.tw/story?id=93)之歷史考證繪製。
...
| 檔案名稱 | 解析度 | 比例 | 狀態 |
|----------|--------|------|------|
| `ROC_flag(240x160).py` | 240 × 160 | 1.0x（基準） | 已上架 |
| `ROC_flag(240x160).ipynb` | 240 × 160 | 1.0x | 已上架，Google Colab 支援 |
...
依據[**武昌首義同志會**](https://www.19111010.com.tw/story?id=93)考證，以旗橫長 $L=20$ 單位為基準：
...
本專案中華民國國旗之核心幾何計算法由 **[sugardaddy16](https://github.com/sugardaddy16)** 與**本人**共同研發完成。

開發過程中，我們投入了整整一天的時間進行數學推導與座標校正。儘管當時正處於重要考試前九天的關鍵衝刺期，我們仍憑藉對程式開發、幾何美學及愛國的熱忱，堅持完成了這項兼具精確度與美觀的專案。特別感謝 Seven 在複雜三角形計算上的校正與貢獻。

鐵血十八星旗之規格考證參考自[武昌首義同志會](https://www.19111010.com.tw)。
...
1. **ROC National Flag** (Blue Sky, White Sun, and a Wholly Red Earth) — drawn strictly following the [**Ministry of the Interior, ROC**](https://www.moi.gov.tw/cp.aspx?n=10621) flag specifications.
2. **Iron Blood 18-Star Flag** (鐵血十八星旗) — the flag of the Hubei Military Government during the 1911 Wuchang Uprising, drawn according to historical research by the [**Wuchang Uprising Comrades Association**](https://www.19111010.com.tw/story?id=93).
...
- **Aspect Ratio**: Red rectangular field, width-to-height = 3:2.
- **Blue Canton**: Upper-left corner, occupying 1/4 of the total flag area.
- **Sun Placement**: Center of the blue canton.
- **Sun Body Radius**: 1/8 of the blue canton height.
- **Twelve Rays**: Spaced at 30° intervals; outer radius = 17/15 × sun body radius. Filled in solid white.

#### Available Versions

| Filename | Resolution | Scale | Status |
|----------|------------|-------|--------|
| `ROC_flag(240x160).py` | 240 × 160 | 1.0x (Base) | Available |
| `ROC_flag(240x160).ipynb` | 240 × 160 | 1.0x | Google Colab Support |
...
Upload to [Google Colab](https://colab.research.google.com) or open directly via GitHub integration.
...
Iron Blood 18-Star Flag specifications referenced from the [Wuchang Uprising Comrades Association](https://www.19111010.com.tw).
